  ...
  return (
    ...
    >
      ...
      <nav className="hidden md:flex items-center gap-7">
        <a
          href="#"
          className="text-sm font-medium text-gray-500 hover:text-[#006C49] transition-colors"
        >
          تعلم
        </a>
        <a
        ...
        <a
          href="#"
          className="border-b-2 border-[#006C49] pb-1 text-sm font-semibold text-[#006C49]"
        >
          تصفح المسارات
        </a>
        <a
